...
export class Camera {
  capture(pulse) {
    throw new Error('Camera.capture not implemented');
  }
}
export class TTL {
  observe(pulse) {
    throw new Error('TTL.observe not implemented');
  }
}
export class Neural {
  preview(pulse) {
    throw new Error('Neural.preview not implemented');
  }
}
export class Writer {
  write(stream, row) {
    throw new Error('Writer.write not implemented');
  }
}
...
export const schemas = {
  frames:
    'session_id,camera_serial,video_part,video_frame_index,camera_block_id,camera_timestamp_ticks,camera_tick_hz,pc_receive_monotonic_ns,record_status,frame_width,frame_height,sim_camera_id,sim_event_id,sim_block_id,sim_camera_ticks,sim_camera_tick_hz,clock_domain',
  ...
  neural:
    'channel,tdt_sample_index,tdt_time_s,value,unit,decimation_factor,sim_sample_index,sim_sample_rate_hz,sim_time_s,clock_domain',
};
